...
public class DbHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sql5=" create table  meter_tb ( MID INTEGER primary key autoincrement,"  //电表ID 唯一标示一个音频 ，自增长
				+ "Name TEXT,"     //电表名称
				+ "Address TEXT,"    //电表地址
				+ "Type TEXT,"    //电表类型，1代表单相电表，3代表三相电表
				+ "VoiceNum TEXT);"; //音频对应的地址
		db.execSQL(sql5);    //创建电表表

		String sql6=" create table  meter_tb ( MID INTEGER primary key autoincrement,"  //电表ID 唯一标示一个音频 ，自增长
				+ "Name TEXT,"     //电表名称
				+ "Address TEXT,"    //电表地址
				+ "Type TEXT,"    //电表类型，1代表单相电表，3代表三相电表
				+ "VoiceNum TEXT);"; //音频对应的地址
